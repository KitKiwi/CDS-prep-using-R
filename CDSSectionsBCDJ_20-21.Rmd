...
# Read in fall ERS state and self files for the enrollment sections, B1 and B2. The data are also used to find 2019 freshmen retention in section B22 and freshman profile, C9-C12. 
...
# Only need to present percentages.
